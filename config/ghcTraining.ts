export const ghcTraining = {
  ...
  specialties: [
    { title: "Pérdida de grasa", schemaName: "Entrenamiento para pérdida de grasa", href: "/perdida-de-grasa" },
    { title: "Fuerza y masa muscular", schemaName: "Entrenamiento para fuerza y masa muscular", href: "/metodo-ghc" },
    { title: "Movilidad y vuelta al entrenamiento", schemaName: "Movilidad y recuperación de la condición física", href: "/valoracion-integral" },
    { title: "Fibromialgia", schemaName: "Entrenamiento adaptado para fibromialgia", href: "/entrenamiento-fibromialgia" },
    { title: "Lipedema", schemaName: "Entrenamiento adaptado para lipedema", href: "/entrenamiento-lipedema" },
    { title: "Linfedema", schemaName: "Entrenamiento adaptado para linfedema", href: "/metodo-ghc" },
    { title: "Dolor crónico", schemaName: "Entrenamiento adaptado para dolor crónico", href: "/metodo-ghc" },
    { title: "Envejecimiento activo", schemaName: "Entrenamiento para envejecimiento activo y autonomía", href: "/metodo-ghc" },
    { title: "Entrenamiento online", schemaName: "Entrenamiento online personalizado", href: "/entrenador-personal-online" },
    { title: "Entrenamiento en Madrid", schemaName: "Entrenamiento personal en Madrid", href: "/entrenador-personal-madrid" },
    { title: "Valoración integral", schemaName: "Valoración integral de la condición física", href: "/valoracion-integral" },
  ],
  quickPath: {
